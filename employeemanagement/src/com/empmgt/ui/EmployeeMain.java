...
public class EmployeeMain {
	...
	private void run() {
		...
		Developer developer1 = new Developer(1, "Saurabh", department1, "React");
		Developer developer2 = new Developer(2, "Ram", department1, "Angular");
		Tester tester1 = new Tester(3, "Nikhil", department2, "Banking");
		Tester tester2 = new Tester(4, "Sudarshan", department2, "Insurance");
